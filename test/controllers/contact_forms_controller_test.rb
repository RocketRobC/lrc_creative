...
class ContactFormsControllerTest < ActionController::TestCase
  ...
  test "should create contact_form" do
    assert_difference('ContactForm.count') do
      post :create, contact_form: { business_name: @contact_form.business_name, details: @contact_form.details, email: @contact_form.email, first_name: @contact_form.first_name, last_name: @contact_form.last_name, phone: @contact_form.phone }
    end
  ...
  test "should update contact_form" do
    patch :update, id: @contact_form, contact_form: { business_name: @contact_form.business_name, details: @contact_form.details, email: @contact_form.email, first_name: @contact_form.first_name, last_name: @contact_form.last_name, phone: @contact_form.phone }
    assert_redirected_to contact_form_path(assigns(:contact_form))
  end
